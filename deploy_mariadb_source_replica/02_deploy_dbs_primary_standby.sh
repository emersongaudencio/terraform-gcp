...
echo '// A single Compute Engine instance
resource "google_compute_instance" "dbstandby01" {
 name         = "dbstandby01"
 machine_type = "n1-standard-4"
 zone         = "europe-west2-a"
